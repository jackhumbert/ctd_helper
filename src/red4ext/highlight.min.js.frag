...
con)for_c++_include"
R"for_c++_include(text:t.slice(j-100,j+100),mode:n.mode,resultSoFar:v},_emitter:M};if(o)return{
...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `swift` grammar compiled for Highlight.js 11.7.0 */
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})();hljs.registerLanguage("swift",e)})();)for_c++_include"
